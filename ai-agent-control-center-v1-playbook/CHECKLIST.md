...
|---|---|---|---|
| [ ] 0 | [00-project-rules.md](00-project-rules.md) | - | architecture, conventions, ADR baseline อนุมัติ |
| [ ] 1 | [01-monorepo.md](01-monorepo.md) | 0 | apps/packages build และ typecheck ได้ |
| [ ] 2 | [02-infrastructure.md](02-infrastructure.md) | 1 | Postgres, Redis, LiteLLM, Ollama พร้อม health checks |
| [ ] 3 | [03-database.md](03-database.md) | 1,2 | Sequelize migrations และ core tables ครบ |
